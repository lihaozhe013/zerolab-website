...
const videos = [
  ...
  {
    title: "太极专家采用 ZeroLab Full body MoCap 完成国粹数据采集",
    videoSrc: "/videos/taiji.mp4",
    description:
      "小小武魁课程体系创始人 阚一工 先生采用 ZeroLab 的无线全身动捕套装 采集 日月式 动作精华数据。ZeroLab Motion Tracker 具备数据稳定性强、精度高等特点，内嵌先进空间位置点捕捉矫正算法，可以采集到更精准的人体关节点位置信息，可快速佩戴、紧密贴合身体。超长8小时待机，不受场地限制，随时随地采集人体动作数据。",
  },
  {
    title: "ZeroLab H-1 Data Gloves For MR Application",
    videoSrc: "/videos/h1.mp4",
    description:
      "ZeroLab Data Gloves，是基于 MEMS 惯性传感器动作捕捉技术的手部动作数字化的交互手套，可以实时识别人体手指的动作姿态，在虚拟交互中呈现精细准确的五指运动。可以让使用者获得身临其境般的交互体验，放松地沉浸在对虚拟空间的探索里。",
  },
];
